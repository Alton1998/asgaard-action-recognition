...
get_ipython().system('pip install -q accelerate -U')
get_ipython().system('pip install -q bitsandbytes -U')
get_ipython().system('pip install -q trl -U')
get_ipython().system('pip install -q peft -U')
get_ipython().system('pip install -q transformers -U')
get_ipython().system('pip install -q datasets -U')
